export MODEL_NAME=OpenGVLab/InternVL3-8B
export EARTHREASON_ROOT=<your_earthreason_root_path_here>
export SAM_SIZE=small
export SAM_ROOT=../../sam2
export RUN_NAME=GEO-InternVL3-8B-EarthReason-GRPO-$SAM_SIZE-$(date +%Y%m%d_%H%M%S)
...
# export MODEL_NAME=OpenGVLab/InternVL3-2B
# export EARTHREASON_ROOT=<your_earthreason_root_path_here>
# export SAM_SIZE=small
# export SAM_ROOT=../../sam2
# export RUN_NAME=GEO-InternVL3-8B-EarthReason-GRPO-$SAM_SIZE-$(date +%Y%m%d_%H%M%S)
